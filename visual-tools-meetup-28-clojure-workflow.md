...
* 1991 - Font editor of the character generator ROM of Hercules cards,
...
* 1994 - Microchip PIC16C84 MCU 8-bit data, 12/14-bit code, 8-level stack
...
* While looking for a rowanj GitX alternative, I remembered from RubyMine,
  how good its VCS support was, so I spent a week learning IntelliJ CE
  and another week Cursive and structural editing, then taught my
  5 people team in another ~2 weeks, by pair-programming with them in
  rotation.
